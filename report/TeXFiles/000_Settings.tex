...
\newcommand{\ThesisTitle}{Report:\\ Real-Time Traffic Simulation with Java \\ Milestone 1}
\newcommand{\ThesisTitleShort}{Real Time Traffic Simulation with Java Report - Milestone 1}
